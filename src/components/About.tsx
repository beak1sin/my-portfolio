        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-accent/20 to-gradient-start/20 rounded-3xl blur-2xl" />
          ...
          >
            <motion.div variants={staggerItem}>
              <h3 className="heading-subsection text-neutral-800 dark:text-neutral-100 mb-6">
                {personalInfo.title}
              </h3>
              <div className="space-y-4">
                ...
                <p className="body-default">
                  저는 성능 문제의 본질을 파고들어 해결하는 개발자입니다.
                  <span className="text-accent font-semibold">
                    {" "}
                    API 호출을 80% 줄이고
                  </span>
