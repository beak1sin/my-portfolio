          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                2019년 서울대병원 전산실에서 일하던 제가, 26살에 안정적인 직장을
                그만두고 개발자의 길을 선택했습니다. 국비교육, 학점은행제, 개인
                프로젝트를 거쳐 SSAFY 12기에 합격했고, 1년 동안 3개 프로젝트
                모두 수상하는 성과를 냈습니다.
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                저는 성능 문제의 본질을 파고들어 해결하는 개발자입니다. API
                호출을 80% 줄였고, 로딩 시간을 57% 단축시켰으며, 듀얼 모니터를
                50ms 이내로 동기화시켰습니다. 숫자로 증명할 수 있는 성과입니다.
              </p>
            </div>
